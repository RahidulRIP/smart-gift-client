        ...
        >
          ...
          <div className="relative z-10 p-12 lg:p-20 lg:w-3/5 text-left">
            ...
            <p className="text-lg text-slate-300 dark:text-blue-50 mb-10 max-w-md leading-relaxed">
              Our AI Curators have identified a 99.2% trending interest in
              Minimalist Noir Gadgets. Secure the exclusive drop before it's
              phased out.
            </p>
          ...
          <div className="relative lg:w-2/5 h-full min-h-100` flex items-center justify-center p-12 lg:p-0">
